...
public class GrupLockPhoneScheduleBasedFinish extends DialogFragment {
    @NonNull
    @Override
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        int hour = Integer.parseInt(et_bsfh.getText().toString());
        int minute = Integer.parseInt(et_bsfm.getText().toString());
